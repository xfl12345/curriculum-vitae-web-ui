<template>
  <div>
    <div style="display: flex; justify-content: space-around">
      <div style="box-sizing: border-box; border: aqua solid 1px; padding: 20px">
        <!--
        <svg
          ref="referenceSVG"
          viewbox="0 0 20 20"
      ...
      <div style="border: aqua solid 1px; padding: 20px; vertical-align: top">
        <img :src="bgDataURL" alt="" />
      </div>
    </div>
    <div>
      <span style="color: blue">SVG data URL </span>
