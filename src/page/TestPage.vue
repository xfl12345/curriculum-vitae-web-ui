  ...
  <n-space vertical>
    ...
    >
      ...
      <n-form-item label="Tree Select" path="treeSelectValue">
        <n-tree-select :options="treeSelectOptions" default-value="Drive My Car" />
      </n-form-item>
...
// import { NSpace, NForm, NFormItem, NInput, NSelect, NUpload, NButton } from "naive-ui";
...
export default defineComponent({
  // components: { NSpace, NForm, NFormItem },
  setup() {
